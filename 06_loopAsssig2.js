...
function countVowels(str) {
    ...
    console.log(`Vowels in given string is : '${vowels}'`);
    console.log(`In given string total number of Vowels is : ${count}`);
}
...
function oddPositionedCharacters(str) {
    ...
    console.log(`Odd characters in given string '${str}' is : \n'${oddCharacters}'`);
}

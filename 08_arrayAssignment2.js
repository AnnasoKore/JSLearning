function arrayNumbers(array) {
  ...
  console.log(
    `First element is - '${array[0]}' and last element is - '${
  ...
  console.log(
    `Is number 115 available in given array - ${array.includes(115)} `
  );
  console.log(`Is number 23 available in given array - ${array.includes(23)} `);
  console.log(
    `Insert numbers 55, 66 before index 3 is - [${
      (array.splice(3, 0, 55, 66), array)
    }]`
  );
  console.log(
    `Delete 3 elements starting from index 4 is - [${
      (array.splice(4, 3), array)
    }]`
  );
}
